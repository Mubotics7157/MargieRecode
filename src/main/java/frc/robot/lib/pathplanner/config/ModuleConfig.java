...
public class ModuleConfig {
    ...
    /**
     * The amount of motor torque lost while driving. Calculated by getting the torque of the motor at the motor's max
     * speed under load.
     */
    public final double torqueLoss;

    /**
     * Configuration of a robot drive module. This can either be a swerve module, or one side of a differential drive
     * train.
     *
     * @param wheelRadiusMeters Radius of the drive wheels, in meters.
     * @param maxDriveVelocityMPS The max speed that the drive motor can reach while actually driving the robot at full
     *     output, in M/S.
     * @param wheelCOF The coefficient of friction between the drive wheel and the carpet. If you are unsure, just use a
    ...
    public ModuleConfig(
        ...
        this.torqueLoss =
                Math.max(this.driveMotor.getTorque(Math.min(maxSpeedCurrentDraw, this.driveCurrentLimit)), 0.0);
    }
     ...
     * @param maxDriveVelocity The max speed that the drive motor can reach while actually driving the robot at full
     *     output.
     * @param wheelCOF The coefficient of friction between the drive wheel and the carpet. If you are unsure, just use a
     *     placeholder value of 1.0.
     * @param driveMotor The DCMotor representing the drive motor gearbox, including gear reduction
