...
public class FlippingUtil {
    ...
    public static ChassisSpeeds flipFieldSpeeds(ChassisSpeeds fieldSpeeds) {
        return switch (symmetryType) {
            case kMirrored -> new ChassisSpeeds(
                    -fieldSpeeds.vxMetersPerSecond, fieldSpeeds.vyMetersPerSecond, -fieldSpeeds.omegaRadiansPerSecond);
    ...
    /**
     * Flip an array of drive feedforwards for the other side of the field. Only does anything if mirrored symmetry is
     * used
     *
    ...
    /**
     * Flip an array of drive feedforward X components for the other side of the field. Only does anything if mirrored
     * symmetry is used
     *
    ...
    /**
     * Flip an array of drive feedforward Y components for the other side of the field. Only does anything if mirrored
     * symmetry is used
     *
