...
public class PathPlannerLogging {
     ...
     *
     * @param logCurrentPose Consumer that accepts the current robot pose. Can be null to disable logging this value.
     */
     ...
     *
     * @param logTargetPose Consumer that accepts the target robot pose. Can be null to disable logging this value.
     */
     ...
     *
     * @param logActivePath Consumer that accepts the active path as a list of poses. Can be null to disable logging
     *     this value.
     */
