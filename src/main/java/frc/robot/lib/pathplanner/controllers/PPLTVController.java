...
public class PPLTVController extends LTVUnicycleController implements PathFollowingController {
    ...
    /**
     * Constructs a linear time-varying unicycle controller with default maximum desired error tolerances of (0.0625 m,
     * 0.125 m, 2 rad) and default maximum desired control effort of (1 m/s, 2 rad/s).
     *
     ...
     *
     * @param dt Discretization timestep in seconds.
     * @param maxVelocity The maximum velocity in meters per second for the controller gain lookup table. The default is
     *     9 m/s.
