...
public class PathPoint {
    ...
    public PathPoint(
            Translation2d position, RotationTarget rotationTarget, PathConstraints constraints, double curvature) {
        this.position = position;
        this.rotationTarget = rotationTarget;
        this.constraints = constraints;
    ...
    public PathPoint(PathPoint other) {
        ...
        distanceAlongPath = other.distanceAlongPath;
        maxV = other.maxV;
        rotationTarget = other.rotationTarget;
        constraints = other.constraints;
        waypointRelativePos = other.waypointRelativePos;
