 ...
 * @param endPosition The end waypoint relative position of the event's zone. A value of -1.0 indicates that this event
 *     is not zoned.
...
public record EventMarker(String triggerName, double position, double endPosition, Command command) {
     ...
     * @param triggerName The name of the trigger this event marker will control
     * @param position The waypoint relative position of the marker
     * @param endPosition The end waypoint relative position of the event's zone. A value of -1.0 indicates that this
     *     event is not zoned.
     */
