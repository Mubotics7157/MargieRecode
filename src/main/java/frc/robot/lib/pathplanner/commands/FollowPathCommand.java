...
import frc.robot.lib.pathplanner.path.*;
...
public class FollowPathCommand extends Command {
     ...
     * @param shouldFlipPath Should the path be flipped to the other side of the field? This will maintain a global blue
     *     alliance origin.
    ...
    public void end(boolean interrupted) {
        ...
        if (!interrupted && path.getGoalEndState().velocityMPS() < 0.1 || DriverStation.isDisabled()) {
