...
/**
 * A command that monitors a running PathfindingCommand and, when its remaining time falls below a specified threshold,
 * schedules an additional command.
 */
public class AdditionalCommandTrigger extends Command {
    ...
    public AdditionalCommandTrigger(
            PathfindingCommand pathfindingCommand, Command additionalCommand, double triggerTimeBeforeEnd) {
