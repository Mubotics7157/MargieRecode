...
public class CommandUtil {
    /**
     * Wraps a command with a functional command that calls the command's initialize, execute, end, and isFinished
     * methods. This allows a command in the event map to be reused multiple times in different command groups
     *
     ...
     */
    public static Command commandFromJson(JSONObject commandJson, boolean loadChoreoPaths, boolean mirror)
    ...
    private static Command pathCommandFromData(JSONObject dataJson, boolean choreoPath, boolean mirror)
            throws IOException, ParseException {
        String pathName = (String) dataJson.get("pathName");

        PathPlannerPath path =
                choreoPath ? PathPlannerPath.fromChoreoTrajectory(pathName) : PathPlannerPath.fromPathFile(pathName);
        if (mirror) {
    ...
    private static Command sequentialGroupFromData(JSONObject dataJson, boolean loadChoreoPaths, boolean mirror)
            throws IOException, ParseException {
    ...
    private static Command parallelGroupFromData(JSONObject dataJson, boolean loadChoreoPaths, boolean mirror)
            throws IOException, ParseException {
    ...
    private static Command raceGroupFromData(JSONObject dataJson, boolean loadChoreoPaths, boolean mirror)
            throws IOException, ParseException {
    ...
    private static Command deadlineGroupFromData(JSONObject dataJson, boolean loadChoreoPaths, boolean mirror)
            throws IOException, ParseException {
