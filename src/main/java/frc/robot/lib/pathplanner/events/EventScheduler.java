 ...
 *
 * <p>Note: The command that is running this scheduler must have the requirements of all commands that will be run
 * during the path being followed.
 */
public class EventScheduler {
    ...
    /**
     * Initialize the EventScheduler for the given trajectory. This should be called from the initialize method of the
     * command running this scheduler.
     *
    ...
    /**
     * End commands currently/events currently being handled by this scheduler. This should be called from the end
    ...
    /**
     * Schedule a command on this scheduler. This will cancel other commands that share requirements with the given
     * command.
     *
