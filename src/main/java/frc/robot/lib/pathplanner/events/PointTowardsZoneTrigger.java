...
public class PointTowardsZoneTrigger extends Trigger {
    ...
    /**
     * Create a new PointTowardsZoneTrigger. This will run on the EventScheduler's event loop, which will be polled any
     * time a path following command is running.
     *
