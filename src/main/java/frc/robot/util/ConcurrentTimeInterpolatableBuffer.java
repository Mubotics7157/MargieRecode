...
/**
 * A concurrent version of WPIlib's TimeInterpolatableBuffer class to avoid the need for explicit synchronization in our
 * robot code. Based on Team 254's implementation.
 *
...
public final class ConcurrentTimeInterpolatableBuffer<T> {
    ...
    /**
     * Get the latest entry in the buffer.
     *
     * @return The latest entry, or null if the buffer is empty.
     */
    ...
    /**
     * Grant access to the internal sample buffer. Used in Pose Estimation to replay odometry inputs stored within this
     * buffer.
     *
