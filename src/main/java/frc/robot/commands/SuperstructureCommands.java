...
public class SuperstructureCommands {
    ...
    // Command to intake gamepiece with timeout, stops trying to intake after timeout seconds no matter if it has
    // gamepiece or not
    ...
    public static Command manualIntake(Superstructure superstructure) {
        return Commands.startEnd(
                        () -> superstructure.requestIntake(), () -> superstructure.requestIdle(), superstructure)
    ...
    public static Command manualOuttake(Superstructure superstructure) {
        return Commands.startEnd(
                        () -> superstructure.requestOuttake(), () -> superstructure.requestIdle(), superstructure)
                .withName("ManualEject");
    }
    ...
    public static Command prepareToShoot(Superstructure superstructure) {
        return Commands.sequence(
                        ...
                        Commands.waitUntil(
                                () -> superstructure.getCurrentState() == Superstructurestate.PREPARING_TO_SHOOT
                                        && superstructure.isReady()))
