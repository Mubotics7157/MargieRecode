...
public abstract class ModuleIOTalonFX implements ModuleIO {
    ...
    public void setDriveVelocity(double velocityRadPerSec) {
        double motorVelocityRadPerSec = Units.radiansToRotations(velocityRadPerSec);
        driveTalon.setControl(
                switch (constants.DriveMotorClosedLoopOutput) {
                    case Voltage -> velocityVoltageRequest.withVelocity(motorVelocityRadPerSec);
                    case TorqueCurrentFOC -> velocityTorqueCurrentRequest.withVelocity(motorVelocityRadPerSec);
                });
    }
